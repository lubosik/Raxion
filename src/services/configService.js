...
export const CONFIG_FIELDS = [
  ...
  { key: 'RAXION_JOB_CONCURRENCY', label: 'Job Concurrency', secret: false, restartRequired: false, category: 'Orchestration', inputType: 'number', description: 'How many jobs Raxion can process in parallel inside one orchestrator cycle.' },
  { key: 'RAXION_JOB_TIMEOUT_MS', label: 'Job Timeout (ms)', secret: false, restartRequired: false, category: 'Orchestration', inputType: 'number', description: 'Maximum runtime for one job cycle before it is failed and the queue moves on.' },
